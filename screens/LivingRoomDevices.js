        ...
        return (
            <View style={styles.container}>
                <View style={styles.rowContainer}>
                    ...
                    <Button
                            onPress={() => this.props.navigation.navigate('VacuumConfig')}
                            title="     Vacuum        " />
                    <TouchableHighlight style={styles.buttonContainer} onPress={()=>this.props.navigation.navigate('VacuumConfig')} >
